        ...
        <div class="card-body">
            <form action="<?php echo e(route('departments.update', $department)); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="department_name" name="department_name" value="<?php echo e($department->department_name); ?>" required>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\company\resources\views/departments/edit.blade.php ENDPATH**/ ?>